...
// //     a.href = data;
// //     // get the name of the file from document title
// //     fileName = (document.getElementsByTagName("title")[0].innerText.split(" ")[2]).toLowerCase();
// //     a.download = `${fileName}.png`;
// //     a.click();
// //     if (fileName == "house")
// //         window.location.href = "/draw-tree.html";
// //     else if (fileName == "tree")
// //         window.location.href = "/draw-person.html";
// //     else
// //         window.location.href = "/result-house.html";
// // });
