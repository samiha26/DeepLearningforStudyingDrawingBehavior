...
try:
    labels_df = pd.read_csv('../data/treeData.csv')
...
# Define callbacks
checkpoint = ModelCheckpoint('vgg16_modelTree.keras', monitor='val_accuracy', save_best_only=True, mode='max', verbose=1)
