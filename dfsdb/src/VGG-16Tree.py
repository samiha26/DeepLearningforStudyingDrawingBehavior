...
image_dir = '../images'
csv_file = '../data/treeData.csv'

# Load labels from CSV
class_dict = {0: 'depression', 1: 'introvert', 2: 'ambitious'}
...
checkpoint = ModelCheckpoint('vgg16_Treemodel.h5', monitor='val_accuracy', save_best_only=True, mode='max', verbose=1)
...
loaded_model = load_model('vgg16_Treemodel.h5')

# Load and preprocess an unknown image
from tensorflow.keras.preprocessing import image

img_path = '../images/tree/3.png'
