...
class_dict = {0: 'depression', 1: 'withdrawal', 2: 'obsession'}

# Loading the data from the .csv file
try:
    labels_df = pd.read_csv('../data/personData.csv')
...
# Define callbacks
checkpoint = ModelCheckpoint('vgg16_modelPerson.keras', monitor='val_accuracy', save_best_only=True, mode='max', verbose=1)
...
# Load a fixed image
fixed_image_path = '../images/person/300.png'
