...
train_len = int(len(housedata) * 0.8)
test_len = len(housedata) - train_len
train_set, val_set = random_split(housedata, [train_len, test_len])
...
for data_item in housedata:
    class_label = data_item['class']
    class_counts[class_label] += 1

# Print the class counts
print("Class Counts for House Images:")
