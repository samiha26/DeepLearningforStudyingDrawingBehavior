...
train_len = int(len(persondata) * 0.8)
test_len = len(persondata) - train_len
train_set, val_set = random_split(persondata, [train_len, test_len])
...
for data_item in persondata:
    class_label = data_item['class']
    class_counts[class_label] += 1

# Print the class counts
print("Class Counts for Person Images:")
